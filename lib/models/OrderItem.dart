...
class OrderItem extends Model {
  ...
  const OrderItem._internal({required this.id, required LineItemId, ShopId, ItemSKU, RecipientID, Status, UpdatedTime, CreatedAt, required DonorUserID, statusTime, ShardID, required RestaurantsID, required zipcode, createdAt, updatedAt}): _LineItemId = LineItemId, _ShopId = ShopId, _ItemSKU = ItemSKU, _RecipientID = RecipientID, _Status = Status, _UpdatedTime = UpdatedTime, _CreatedAt = CreatedAt, _DonorUserID = DonorUserID, _statusTime = statusTime, _ShardID = ShardID, _RestaurantsID = RestaurantsID, _zipcode = zipcode, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory OrderItem({String? id, required String LineItemId, String? ShopId, String? ItemSKU, String? RecipientID, String? Status, TemporalTimestamp? UpdatedTime, TemporalTimestamp? CreatedAt, required String DonorUserID, TemporalTimestamp? statusTime, String? ShardID, required String RestaurantsID, required String zipcode}) {
  ...
  OrderItem copyWith({String? id, String? LineItemId, String? ShopId, String? ItemSKU, String? RecipientID, String? Status, TemporalTimestamp? UpdatedTime, TemporalTimestamp? CreatedAt, String? DonorUserID, TemporalTimestamp? statusTime, String? ShardID, String? RestaurantsID, String? zipcode}) {
    return OrderItem._internal(
      id: id ?? this.id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'LineItemId': _LineItemId, 'ShopId': _ShopId, 'ItemSKU': _ItemSKU, 'RecipientID': _RecipientID, 'Status': _Status, 'UpdatedTime': _UpdatedTime?.toSeconds(), 'CreatedAt': _CreatedAt?.toSeconds(), 'DonorUserID': _DonorUserID, 'statusTime': _statusTime?.toSeconds(), 'ShardID': _ShardID, 'RestaurantsID': _RestaurantsID, 'zipcode': _zipcode, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'LineItemId': _LineItemId, 'ShopId': _ShopId, 'ItemSKU': _ItemSKU, 'RecipientID': _RecipientID, 'Status': _Status, 'UpdatedTime': _UpdatedTime, 'CreatedAt': _CreatedAt, 'DonorUserID': _DonorUserID, 'statusTime': _statusTime, 'ShardID': _ShardID, 'RestaurantsID': _RestaurantsID, 'zipcode': _zipcode, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
